        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="#objective" className="text-gray-300 hover:text-primary transition-colors">
                    Research Objectives
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#download" className="text-gray-300 hover:text-primary transition-colors">
                    Download
                  </a>
                </li>
              </ul>
          ...
          <div className="bg-gray-800 rounded-lg p-6 text-center">
            <p className="text-gray-300 text-sm">
              This research project is part of an ongoing study in educational technology. 
              For academic collaborations or research inquiries, please contact our research team.
            </p>
          </div>
        </div>
      </div>
